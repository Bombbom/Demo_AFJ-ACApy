...
import { 
    ...
    CredentialsModule,
    Agent,
    HttpOutboundTransport, } from "@aries-framework/core";   
...
export class BaseAgent {
    ...
    public async initializeAgent(){
        ...
        //TODO: greenText functions()
        // Show log: when agent is created. Format: Agent (name) was created!
        console.log(greenText(`\nAgent ${this.name} was created!\n`));
    }
